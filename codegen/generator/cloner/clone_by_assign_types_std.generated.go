...
var stdCloneByAssign = map[imports.TargetType]struct{}{
	...
	{ImportPath: "crypto/sha3", Name: "SHA3"}:                              {},
	...
	{ImportPath: "debug/elf", Name: "DynamicVersionDep"}:                   {},
	...
	{ImportPath: "net/http", Name: "Protocols"}:                            {},
	...
	{ImportPath: "runtime", Name: "Cleanup"}:                               {},
	...
	{ImportPath: "runtime/trace", Name: "FlightRecorderConfig"}:            {},
