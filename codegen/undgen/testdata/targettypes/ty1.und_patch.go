...
func (p *AllPatch) FromValue(v All) {
	...
	*p = AllPatch{
		...
		UntouchedOpt:             option.MapOrOption(v.UntouchedOpt, sliceund.Null[int](), sliceund.Defined[int]),
		UntouchedUnd:             v.UntouchedUnd,
		UntouchedSliceUnd:        v.UntouchedSliceUnd,
		OptRequired:              option.MapOrOption(v.OptRequired, sliceund.Null[string](), sliceund.Defined[string]),
		OptNullish:               option.MapOrOption(v.OptNullish, sliceund.Null[string](), sliceund.Defined[string]),
		OptDef:                   option.MapOrOption(v.OptDef, sliceund.Null[string](), sliceund.Defined[string]),
		OptNull:                  option.MapOrOption(v.OptNull, sliceund.Null[string](), sliceund.Defined[string]),
		OptUnd:                   option.MapOrOption(v.OptUnd, sliceund.Null[string](), sliceund.Defined[string]),
		OptDefOrUnd:              option.MapOrOption(v.OptDefOrUnd, sliceund.Null[string](), sliceund.Defined[string]),
		OptDefOrNull:             option.MapOrOption(v.OptDefOrNull, sliceund.Null[string](), sliceund.Defined[string]),
		OptNullOrUnd:             option.MapOrOption(v.OptNullOrUnd, sliceund.Null[string](), sliceund.Defined[string]),
		OptDefOrNullOrUnd:        option.MapOrOption(v.OptDefOrNullOrUnd, sliceund.Null[string](), sliceund.Defined[string]),
...
func (p AllPatch) ToValue() All {
	...
	return All{
		...
		Baz:                      p.Baz.Value(),
		Qux:                      p.Qux.Value(),
		UntouchedOpt:             option.FlattenOption(p.UntouchedOpt.Unwrap()),
		UntouchedUnd:             p.UntouchedUnd,
		UntouchedSliceUnd:        p.UntouchedSliceUnd,
		OptRequired:              option.FlattenOption(p.OptRequired.Unwrap()),
		OptNullish:               option.FlattenOption(p.OptNullish.Unwrap()),
		OptDef:                   option.FlattenOption(p.OptDef.Unwrap()),
		OptNull:                  option.FlattenOption(p.OptNull.Unwrap()),
		OptUnd:                   option.FlattenOption(p.OptUnd.Unwrap()),
		OptDefOrUnd:              option.FlattenOption(p.OptDefOrUnd.Unwrap()),
		OptDefOrNull:             option.FlattenOption(p.OptDefOrNull.Unwrap()),
		OptNullOrUnd:             option.FlattenOption(p.OptNullOrUnd.Unwrap()),
		OptDefOrNullOrUnd:        option.FlattenOption(p.OptDefOrNullOrUnd.Unwrap()),
...
func (p *WithTypeParamPatch[T]) FromValue(v WithTypeParam[T]) {
	...
	*p = WithTypeParamPatch[T]{
		Foo: sliceund.Defined(v.Foo),
		Bar: sliceund.Defined(v.Bar),
		Baz: option.MapOrOption(v.Baz, sliceund.Null[T](), sliceund.Defined[T]),
	}
}
...
func (p WithTypeParamPatch[T]) ToValue() WithTypeParam[T] {
	...
	return WithTypeParam[T]{
		Foo: p.Foo.Value(),
		Bar: p.Bar.Value(),
		Baz: option.FlattenOption(p.Baz.Unwrap()),
	}
}
